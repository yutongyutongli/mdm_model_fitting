...
root = 'D:\Ruonan\Projects in the lab\MDM Project\Medical Decision Making Imaging\MDM_imaging\Behavioral Analysis\Survey';
filename = ['MDM_BISBAS_BIS11_DOSPERT_' wave '.xlsx'];
...
%% Print to .xlsx
outputname = ['MDM_BISBAS_BIS11_DOSPERT_factor_' wave '.xlsx'];
...
t = table(subjId,...
    ...
    dospertEbEAv, dospertEbFiAv, dospertEbFgAv, dospertEbHsAv, dospertEbRAv, dospertEbSAv);
