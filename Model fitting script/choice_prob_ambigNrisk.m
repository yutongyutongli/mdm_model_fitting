...
%     p1 = 1 ./ (1 + exp(beta(1)*(uA-uF)));
    ...
    if (strcmp(model,'ambigNriskFixSlope'))
        ...
        slope = -1
    elseif (strcmp(model,'ambigNrisk') || strcmp(model,'ambiguity') || strcmp(model,'ambigPower') || strcmp(model,'ambigSubjRate')) || strcmp(model,'riskAmbigPremiumVar') || strcmp(model, 'riskAmbigPremiumStd') || strcmp(model,'riskPremium') || strcmp(model,'riskAmbigPremium')
